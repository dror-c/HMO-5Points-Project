    ...
    public partial class DoctorOrNurseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT Address, DateOfBirth, FirstName, ID, IsDoctorOrNurse, LastName, MaleFemale" +
                ", PhoneNumber FROM DoctorOrNurse";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[3].CommandText = "SELECT Address, DateOfBirth, FirstName, ID, IsDoctorOrNurse, LastName, MaleFemale" +
                ", PhoneNumber FROM DoctorOrNurse WHERE EXISTS (SELECT DoctorOrNurseId FROM Conne" +
                "ctionDoctorDepartment WHERE (DoctorOrNurseId = DoctorOrNurse.ID) AND (Department" +
                "Id = ?))";
