...
{
    public partial class toDelete : UserControl
    {
        private Form parent;
        ...
        {
            frmOrderTherapyFinal f = new frmOrderTherapyFinal(inputId.Text, new Form());
            this.Hide();
            f.ShowDialog();
        }
        ...
        private void lastNameSearch_TextChanged_1(object sender, EventArgs e)
        {
